...
export class JobBidComponent implements OnInit, OnDestroy {
    ...
    constructor(
        protected jobBidService: JobBidService,
    ...
    loadAll() {
        if (this.currentSearch) {
            this.jobBidService
                ...
                .subscribe(
                    (res: HttpResponse<IJobBid[]>) => this.paginateJobBids(res.body, res.headers),
    ...
    protected paginateJobBids(data: IJobBid[], headers: HttpHeaders) {
